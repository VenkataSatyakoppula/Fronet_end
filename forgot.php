    ...
    <section class="in-center">
        ...
        <div class="card container custom bg-dark rounded-3">
            ...
            <div class="sucess-mail d-flex flex-column mt-5 d-none">
              ...
              <h3 class="text-light mt-2 justify text-center">Password reset instructions has been sent Successfully</h3>
              <p class="mt-2 text-center"><a href="login.php" class="text-info"> Go to Login Page</a></p>
            </div>
            <div id="reset-body">
            <h1 class="card-title text-center text-light mb-3"> <i class="fa-regular fa-envelope"></i> Password Reset</h1>
            <p class="text-light">We'll Send a link to your mail for password reset, if you have given valid email address during registration and if an account exists</p>
            <form id="reset-form">
                <div class="mb-3">
              ...
              <p class="text-info"><a href="login.php" class="text-info">Remebered password ? Login</a></p>
              </div>
